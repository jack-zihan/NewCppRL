...
class ObservationGenerator:
    ...
    def generate_observation(self, agent: Agent,
                             maps_input: Union[Dict[str, Dict[str, Any]], Dict[str, np.ndarray]]) -> np.ndarray:
        """
        生成观察
    ...
    def _preprocess_maps(self, maps_input: Union[Dict[str, Dict[str, Any]], Dict[str, np.ndarray]]) -> Dict[
        str, Dict[str, Any]]:
        """预处理地图输入，确保格式统一"""
        # 兼容两种输入格式
